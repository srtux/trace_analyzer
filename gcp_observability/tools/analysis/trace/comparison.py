...
def compare_span_timings(  # noqa: C901
    ...
    with tracer.start_as_current_span("compare_span_timings") as span:
        ...
        try:
            ...
            span.set_attribute("gcp_observability.slower_spans_count", len(slower_spans))
