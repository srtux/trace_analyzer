...
class TestCUJ_IncidentInvestigation:
    ...
    def test_log_pattern_analysis_in_incident(
        ...
        from gcp_observability.tools.analysis.logs.patterns import compare_log_patterns
...
class TestCUJ_PerformanceDebugging:
    ...
    def test_span_timing_extraction(self):
        ...
        from gcp_observability.tools.analysis.trace.analysis import calculate_span_durations
...
class TestCUJ_ErrorDiagnosis:
    ...
    def test_error_pattern_detection(self):
        ...
        from gcp_observability.tools.analysis.logs.patterns import analyze_log_anomalies
