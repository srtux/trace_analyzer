...
from gcp_observability.tools.common.telemetry import get_meter, get_tracer


def test_get_tracer():
    with mock.patch("gcp_observability.tools.common.telemetry.trace.get_tracer_provider") as mock_get_provider:
...
def test_get_meter():
    with mock.patch("gcp_observability.tools.common.telemetry.metrics.get_meter") as mock_get_meter:
...
def test_logging_filter():
    ...
    from gcp_observability.tools.common.telemetry import _FunctionCallWarningFilter
