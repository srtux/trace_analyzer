...
from gcp_observability.tools.analysis.trace.comparison import (
...
def mock_calculate_durations():
    with patch("gcp_observability.tools.analysis.trace.comparison.calculate_span_durations") as mock:
        yield mock

@pytest.fixture
def mock_build_call_graph():
    with patch("gcp_observability.tools.analysis.trace.comparison.build_call_graph") as mock:
        yield mock
