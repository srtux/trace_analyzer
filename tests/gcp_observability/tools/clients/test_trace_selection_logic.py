...
from gcp_observability.tools.clients.trace import find_example_traces, get_trace_by_url

@patch("gcp_observability.tools.clients.trace.list_traces")
@patch("gcp_observability.tools.clients.trace._get_project_id", return_value="p")
def test_find_example_traces_hybrid(mock_pid, mock_list_traces):
    ...
    # Call function
    result_json = find_example_traces(project_id="p", prefer_errors=False)
...
@patch("gcp_observability.tools.clients.trace.fetch_trace")
