...
from gcp_observability.tools.clients.logging import list_log_entries, list_error_events
...
import gcp_observability.tools.clients.trace as trace_client
...
class TestGetTraceByURL:
    ...
    def test_extract_trace_id_from_url(self):
        ...
        with patch("gcp_observability.tools.clients.trace.fetch_trace") as mock_fetch:
