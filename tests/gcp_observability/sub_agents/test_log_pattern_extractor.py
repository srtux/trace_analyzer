...
from gcp_observability.tools.analysis.logs.patterns import (
    extract_log_patterns,
    compare_log_patterns,
    analyze_log_anomalies,
)
from gcp_observability.tools.analysis.logs.extraction import (
    extract_log_message,
...
class TestSubAgentConfiguration:
    ...
    def test_subagent_has_required_tools(self):
        ...
        from gcp_observability.sub_agents.logs import log_pattern_extractor
...
class TestMainAgentIntegration:
    ...
    def test_main_agent_has_log_pattern_extractor(self):
        ...
        sub_agent_names = [sa.name for sa in gcp_observability.sub_agents]
    ...
    def test_main_agent_has_log_pattern_tools(self):
        ...
        from gcp_observability.agent import base_tools
    ...
    def test_main_agent_prompt_mentions_log_analysis(self):
        ...
        from gcp_observability.prompt import SRE_AGENT_PROMPT
