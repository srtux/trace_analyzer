...
def test_compare_span_timings_n_plus_one_detection():
    ...
    with patch("trace_analyzer.tools.trace_analysis.fetch_trace", side_effect=lambda pid, tid: tid):
        baseline = {
            "trace_id": "base",
...
def test_compare_span_timings_serial_chain_detection():
    ...
    with patch("trace_analyzer.tools.trace_analysis.fetch_trace", side_effect=lambda pid, tid: tid):
        baseline = {
            "trace_id": "base",
            "spans": [{"span_id": "r", "name": "root", "start_time": "2023-01-01T00:00:00Z", "end_time": "2023-01-01T00:00:05Z"}]
        }
